...
int main()
{
    ...
    TFile* fout = new TFile((output_folder+namef_rc_kt_data_d).c_str(),"RECREATE");
    gROOT->cd();
    ...
    TH1F* hdecays_diffsign = new TH1F("hdecays_diffsign","",Nbin_kt,kt_limits);
    ...
    TH1F* hdecays_samesign = new TH1F("hdecays_samesign","",Nbin_kt,kt_limits);

    // Get the string breaking fraction
    ntuple_decays->Project("hall_diffsign"   ,"dh_kt",jet_cuts+trackmc_cuts+"eq_charge==0");
    ntuple_decays->Project("hstrbrk_diffsign","dh_kt",jet_cuts+trackmc_cuts+"eq_charge==0&&lh_motherid<22&&lh_motherid>-10&&nlh_motherid<22&&nlh_motherid>-10");
    ntuple_decays->Project("hall_samesign"   ,"dh_kt",jet_cuts+trackmc_cuts+"eq_charge==1");
    ntuple_decays->Project("hstrbrk_samesign","dh_kt",jet_cuts+trackmc_cuts+"eq_charge==1&&lh_motherid<22&&lh_motherid>-10&&nlh_motherid<22&&nlh_motherid>-10");
