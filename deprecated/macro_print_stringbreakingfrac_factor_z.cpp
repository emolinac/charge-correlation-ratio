...
void macro_print_stringbreakingfrac_factor_z()
{
    ...
    TH1F* h_eqcharge_all    = new TH1F("h_eqcharge_all"   ,"",Nbin_z,z_limits);
    TH1F* h_neqcharge_all   = new TH1F("h_neqcharge_all"  ,"",Nbin_z,z_limits);
    ...
    hs->SetTitle(";z;Frac. events from q/g");
