...
void macro_print_z_diffmothers()
{
    ...
    ntuple_decay->Project("hdecay_diffsign"    ,"nlh_z",local_jet_pt_cut+jet_cuts+trackmc_cuts+"eq_charge==0&&(lh_motherid>22||lh_motherid<-10)&&(nlh_motherid>22||nlh_motherid<-10)&&(lh_motherid!=-99&&nlh_motherid!=99)");
    ...
    ntuple_decay->Project("hdecay_samesign"    ,"nlh_z",local_jet_pt_cut+jet_cuts+trackmc_cuts+"eq_charge==1&&(lh_motherid>22||lh_motherid<-10)&&(nlh_motherid>22||nlh_motherid<-10)&&(lh_motherid!=-99&&nlh_motherid!=99)");
