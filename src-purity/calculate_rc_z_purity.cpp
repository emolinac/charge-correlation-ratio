...
int main()
{
    ...
    TFile* fout = new TFile((output_folder+namef_rc_z_data_p).c_str(),"RECREATE");
    gROOT->cd();
    ...
    // Apply purities
    TH1F* hcs_samesign_p = new TH1F("hcs_samesign_p","",Nbin_z,z_min,z_max);
    TH1F* hcs_diffsign_p = new TH1F("hcs_diffsign_p","",Nbin_z,z_min,z_max);
