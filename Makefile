...
${BIN}/create_invmass_ntuple: ${SRC_S}/create_invmass_ntuple.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_S}/create_invmass_ntuple.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_invmass_ntuple

${BIN}/create_invmasstrio_ntuple: ${SRC_S}/create_invmasstrio_ntuple.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_S}/create_invmasstrio_ntuple.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_invmasstrio_ntuple
...
${BIN}/calculate_rc_jet_pt_stringbreakingfrac: ${SRC_S}/calculate_rc_jet_pt_stringbreakingfrac.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_S}/calculate_rc_jet_pt_stringbreakingfrac.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/calculate_rc_jet_pt_stringbreakingfrac
