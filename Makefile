...
all: ${BIN}/create_ntuples \
	 ...
	 ${BIN}/create_resolution_ntuple ${BIN}/create_unfold_ntuple ${BIN}/create_muon_ntuple ${BIN}/create_invmass_ntuple \
...
${BIN}/calculate_rc_z_stringbreakingfrac: ${SRC_D}/calculate_rc_z_stringbreakingfrac.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_D}/calculate_rc_z_stringbreakingfrac.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/calculate_rc_z_stringbreakingfrac

${BIN}/calculate_rc_kt_stringbreakingfrac: ${SRC_D}/calculate_rc_kt_stringbreakingfrac.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_D}/calculate_rc_kt_stringbreakingfrac.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/calculate_rc_kt_stringbreakingfrac

${BIN}/calculate_rc_jet_pt_stringbreakingfrac: ${SRC_D}/calculate_rc_jet_pt_stringbreakingfrac.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_D}/calculate_rc_jet_pt_stringbreakingfrac.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/calculate_rc_jet_pt_stringbreakingfrac
