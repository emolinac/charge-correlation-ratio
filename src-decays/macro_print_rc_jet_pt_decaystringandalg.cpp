...
void macro_print_rc_jet_pt_decaystringandalg()
{
    ...
    // Create decay plots
    TH1F* hstrbrk_diffsign = new TH1F("hstrbrk_diffsign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* hstrbrk_samesign = new TH1F("hstrbrk_samesign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* hstrbrk_sum      = new TH1F("hstrbrk_sum"     ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hstrbrk_sub      = new TH1F("hstrbrk_sub"     ,"",Nbin_jet_pt,jet_pt_limits);

    TH1F* hstrbrkalg_diffsign = new TH1F("hstrbrkalg_diffsign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* hstrbrkalg_samesign = new TH1F("hstrbrkalg_samesign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* hstrbrkalg_sum      = new TH1F("hstrbrkalg_sum"     ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hstrbrkalg_sub      = new TH1F("hstrbrkalg_sub"     ,"",Nbin_jet_pt,jet_pt_limits);
    ...
    TH1F* hrc_strbrk    = new TH1F("hrc_strbrk"   ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hrc_strbrkalg = new TH1F("hrc_strbrkalg","",Nbin_jet_pt,jet_pt_limits);
    ...
    ntuple_decay->Project("hdecay_diffsign"    ,"jet_pt",dh_kt_cut+nlh_z_cut+jet_cuts+trackmc_cuts+"eq_charge==0&&(lh_motherid>99||lh_motherid<-99)&&(nlh_motherid>99||nlh_motherid<-99)");
    ...
    ntuple_decay->Project("hdecay_samesign"    ,"jet_pt",dh_kt_cut+nlh_z_cut+jet_cuts+trackmc_cuts+"eq_charge==1&&(lh_motherid>99||lh_motherid<-99)&&(nlh_motherid>99||nlh_motherid<-99)");
