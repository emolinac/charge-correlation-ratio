...
int main()
{
    ...
    ntuple_datadecays->Project("hall_diffsign"   ,"nlh_z",jet_cuts+trackmc_cuts+"eq_charge==0");
    ntuple_datadecays->Project("hstrbrk_diffsign","nlh_z",jet_cuts+trackmc_cuts+"eq_charge==0&&combs==0");
    ntuple_datadecays->Project("hall_samesign"   ,"nlh_z",jet_cuts+trackmc_cuts+"eq_charge==1");
    ntuple_datadecays->Project("hstrbrk_samesign","nlh_z",jet_cuts+trackmc_cuts+"eq_charge==1&&combs==0");
    hdatadecays_diffsign->Divide(hstrbrk_diffsign,hall_diffsign,1,1,"B");
    hdatadecays_samesign->Divide(hstrbrk_samesign,hall_samesign,1,1,"B");
