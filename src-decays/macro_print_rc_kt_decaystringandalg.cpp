...
void macro_print_rc_kt_decaystringandalg()
{
    ...
    ntuple_decay->Project("hdecay_diffsign"    ,"dh_kt",local_jet_pt_cut/*+nlh_z_cut*/+jet_cuts+trackmc_cuts+"eq_charge==0&&(lh_motherid>22||lh_motherid<-10)&&(nlh_motherid>22||nlh_motherid<-10)&&(lh_motherid!=-99&&nlh_motherid!=99)");
    ...
    ntuple_decay->Project("hdecay_samesign"    ,"dh_kt",local_jet_pt_cut/*+nlh_z_cut*/+jet_cuts+trackmc_cuts+"eq_charge==1&&(lh_motherid>22||lh_motherid<-10)&&(nlh_motherid>22||nlh_motherid<-10)&&(lh_motherid!=-99&&nlh_motherid!=99)");
