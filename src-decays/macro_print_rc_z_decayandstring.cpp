...
void macro_print_rc_z_decayandstring()
{
    ...
    ntuple_decay->Project("hdecay_diffsign" ,"nlh_z",jet_cuts+trackmc_cuts+"eq_charge==0&&(lh_motherid>22||lh_motherid<-10)&&(nlh_motherid>22||nlh_motherid<-10)");
    ...
    ntuple_decay->Project("hdecay_samesign" ,"nlh_z",jet_cuts+trackmc_cuts+"eq_charge==1&&(lh_motherid>22||lh_motherid<-10)&&(nlh_motherid>22||nlh_motherid<-10)");
