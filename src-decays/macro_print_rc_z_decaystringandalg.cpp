...
void macro_print_rc_z_decaystringandalg()
{
    ...
    ntuple_decay->Project("hdecay_diffsign"    ,"nlh_z",local_jet_pt_cut/*+dh_kt_cut*/+jet_cuts+trackmc_cuts+"eq_charge==0&&(lh_motherid>99||lh_motherid<-99)&&(nlh_motherid>99||nlh_motherid<-99)");
    ...
    ntuple_decay->Project("hdecay_samesign"    ,"nlh_z",local_jet_pt_cut/*+dh_kt_cut*/+jet_cuts+trackmc_cuts+"eq_charge==1&&(lh_motherid>99||lh_motherid<-99)&&(nlh_motherid>99||nlh_motherid<-99)");
