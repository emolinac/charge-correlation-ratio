...
void macro_print_rc_jet_pt_allmc()
{
    ...
    TH1F* hparton_diffsign = new TH1F("hparton_diffsign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* hparton_samesign = new TH1F("hparton_samesign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* hparton_sum      = new TH1F("hparton_sum"     ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hparton_sub      = new TH1F("hparton_sub"     ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hrc_parton       = new TH1F("hrc_parton"      ,"",Nbin_jet_pt,jet_pt_limits);

    // Create dsame partons as mothers plots
    TH1F* heqparton_diffsign = new TH1F("heqparton_diffsign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* heqparton_samesign = new TH1F("heqparton_samesign","",Nbin_jet_pt,jet_pt_limits);
    TH1F* heqparton_sum      = new TH1F("heqparton_sum"     ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* heqparton_sub      = new TH1F("heqparton_sub"     ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hrc_eqparton       = new TH1F("hrc_eqparton"      ,"",Nbin_jet_pt,jet_pt_limits);

    // Create decay plots
    TH1F* hdecay_samesign  = new TH1F("hdecay_samesign" ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hdecay_diffsign  = new TH1F("hdecay_diffsign" ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hdecay_sum       = new TH1F("hdecay_sum"      ,"",Nbin_jet_pt,jet_pt_limits);
    TH1F* hdecay_sub       = new TH1F("hdecay_sub"      ,"",Nbin_jet_pt,jet_pt_limits);
    ...
    ntuple_decay->Project("hdecay_diffsign"    ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==0"+decay_motherid_cut);
    ntuple_decay->Project("hparton_diffsign"   ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==0"+parton_motherid_cut);
    ntuple_decay->Project("heqparton_diffsign" ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==0"+eqparton_motherid_cut);
    ntuple_decay->Project("hdecay_samesign"    ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==1"+decay_motherid_cut);
    ntuple_decay->Project("hparton_samesign"   ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==1"+parton_motherid_cut);
    ntuple_decay->Project("heqparton_samesign" ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==1"+eqparton_motherid_cut);
