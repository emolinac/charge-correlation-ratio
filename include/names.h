...
const char* ntuple_unfold_vars     = "eq_charge:lh_chi2:nlh_chi2:lh_ndf:nlh_ndf:lh_probnnghost:nlh_probnnghost:lh_p:nlh_p:lh_pt:nlh_pt:dh_z_mcreco:dh_z_mc:dh_kt_mcreco:dh_kt_mc:lh_pz:nlh_pz:jet_pt_mcreco:jet_pt_mc:jet_eta:jet_phi:z0_phi:mum_phi:mum_pt:mum_eta:mum_px:mum_py:mum_pz:mum_pe:mum_m:mum_probchi2:mup_phi:mup_pt:mup_eta:mup_px:mup_py:mup_pz:mup_pe:mup_m:mup_probchi2:signal";
