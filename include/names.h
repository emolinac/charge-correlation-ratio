...
const char* ntuple_data_vars   = "eq_charge:dh_m:lh_id:nlh_id:lh_chi2:nlh_chi2:lh_ndf:nlh_ndf:lh_probnnghost:nlh_probnnghost:lh_p:nlh_p:lh_pt:nlh_pt:lh_z:nlh_z:lh_jt:nlh_jt:lh_pz:nlh_pz:jet_pt:jet_eta:jet_phi:z0_phi:mum_phi:mum_pt:mum_eta:mum_px:mum_py:mum_pz:mum_pe:mum_m:mum_probchi2:mup_phi:mup_pt:mup_eta:mup_px:mup_py:mup_pz:mup_pe:mup_m:mup_probchi2";
...
const char* ntuple_decays_vars = "eq_charge:lh_id:nlh_id:lh_motherid:nlh_motherid:lh_topmotherid:nlh_topmotherid:lh_p:nlh_p:lh_pt:nlh_pt:lh_z:nlh_z:lh_jt:nlh_jt:lh_pz:nlh_pz:jet_pt:jet_eta:jet_phi";
