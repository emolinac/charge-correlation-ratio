...
std::string mother_folder = "/home/esteban/Documents/umich-work/lhcb/charge-correlation-ratio-Z/";
std::string output_folder = mother_folder+"output-files/";
std::string input_folder  = mother_folder+"input-files/";

// Names of the files
std::string name_rc_z_mc          = "rc_z_mc.root";
std::string name_rc_z_mcreco      = "rc_z_mcreco.root";
std::string name_rc_z_data        = "rc_z_data.root";
std::string name_rc_jt_mc         = "rc_jt_mc.root";
std::string name_rc_jt_mcreco     = "rc_jt_mcreco.root";
std::string name_rc_jt_data       = "rc_jt_data.root";
std::string name_rc_jet_pt_mc     = "rc_jet_pt_mc.root";
std::string name_rc_jet_pt_mcreco = "rc_jet_pt_mcreco.root";
std::string name_rc_jet_pt_data   = "rc_jet_pt_data.root";
std::string name_ntuple_dihadron  = "ntuple_dihadron.root";
