...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        MCJet_truth_match_mup_PX;
   Double_t        MCJet_truth_match_mup_PY;
   Double_t        MCJet_truth_match_mup_PZ;
   Int_t           MCJet_truth_match_mup_TYPE;
   Double_t        MCJet_truth_match_mup_CHI2;
   Int_t           MCJet_truth_match_mup_NDOF;
   Double_t        MCJet_truth_match_mup_PROBCHI2;
   Double_t        MCJet_truth_match_mum_PX;
   Double_t        MCJet_truth_match_mum_PY;
   Double_t        MCJet_truth_match_mum_PZ;
   Int_t           MCJet_truth_match_mum_TYPE;
   Double_t        MCJet_truth_match_mum_CHI2;
   Int_t           MCJet_truth_match_mum_NDOF;
   Double_t        MCJet_truth_match_mum_PROBCHI2;
   ...
   TBranch        *b_MCJet_truth_match_mup_PX;   //!
   TBranch        *b_MCJet_truth_match_mup_PY;   //!
   TBranch        *b_MCJet_truth_match_mup_PZ;   //!
   TBranch        *b_MCJet_truth_match_mup_TYPE;   //!
   TBranch        *b_MCJet_truth_match_mup_CHI2;   //!
   TBranch        *b_MCJet_truth_match_mup_NDOF;   //!
   TBranch        *b_MCJet_truth_match_mup_PROBCHI2;   //!
   TBranch        *b_MCJet_truth_match_mum_PX;   //!
   TBranch        *b_MCJet_truth_match_mum_PY;   //!
   TBranch        *b_MCJet_truth_match_mum_PZ;   //!
   TBranch        *b_MCJet_truth_match_mum_TYPE;   //!
   TBranch        *b_MCJet_truth_match_mum_CHI2;   //!
   TBranch        *b_MCJet_truth_match_mum_NDOF;   //!
   TBranch        *b_MCJet_truth_match_mum_PROBCHI2;   //!
...
#ifdef TMCJets_cxx
TMCJets::TMCJets(TTree *tree) : fChain(0) 
{
...
Int_t TMCJets::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TMCJets::LoadTree(Long64_t entry)
{
...
void TMCJets::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("MCJet_truth_match_mup_PX", &MCJet_truth_match_mup_PX, &b_MCJet_truth_match_mup_PX);
   fChain->SetBranchAddress("MCJet_truth_match_mup_PY", &MCJet_truth_match_mup_PY, &b_MCJet_truth_match_mup_PY);
   fChain->SetBranchAddress("MCJet_truth_match_mup_PZ", &MCJet_truth_match_mup_PZ, &b_MCJet_truth_match_mup_PZ);
   fChain->SetBranchAddress("MCJet_truth_match_mup_TYPE", &MCJet_truth_match_mup_TYPE, &b_MCJet_truth_match_mup_TYPE);
   fChain->SetBranchAddress("MCJet_truth_match_mup_CHI2", &MCJet_truth_match_mup_CHI2, &b_MCJet_truth_match_mup_CHI2);
   fChain->SetBranchAddress("MCJet_truth_match_mup_NDOF", &MCJet_truth_match_mup_NDOF, &b_MCJet_truth_match_mup_NDOF);
   fChain->SetBranchAddress("MCJet_truth_match_mup_PROBCHI2", &MCJet_truth_match_mup_PROBCHI2, &b_MCJet_truth_match_mup_PROBCHI2);
   fChain->SetBranchAddress("MCJet_truth_match_mum_PX", &MCJet_truth_match_mum_PX, &b_MCJet_truth_match_mum_PX);
   fChain->SetBranchAddress("MCJet_truth_match_mum_PY", &MCJet_truth_match_mum_PY, &b_MCJet_truth_match_mum_PY);
   fChain->SetBranchAddress("MCJet_truth_match_mum_PZ", &MCJet_truth_match_mum_PZ, &b_MCJet_truth_match_mum_PZ);
   fChain->SetBranchAddress("MCJet_truth_match_mum_TYPE", &MCJet_truth_match_mum_TYPE, &b_MCJet_truth_match_mum_TYPE);
   fChain->SetBranchAddress("MCJet_truth_match_mum_CHI2", &MCJet_truth_match_mum_CHI2, &b_MCJet_truth_match_mum_CHI2);
   fChain->SetBranchAddress("MCJet_truth_match_mum_NDOF", &MCJet_truth_match_mum_NDOF, &b_MCJet_truth_match_mum_NDOF);
   fChain->SetBranchAddress("MCJet_truth_match_mum_PROBCHI2", &MCJet_truth_match_mum_PROBCHI2, &b_MCJet_truth_match_mum_PROBCHI2);
...
void TMCJets::Show(Long64_t entry)
{
...
Int_t TMCJets::Cut(Long64_t entry)
{
