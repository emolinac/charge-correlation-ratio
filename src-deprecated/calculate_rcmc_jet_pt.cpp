...
int main()
{
    ...
    TFile* fout = new TFile((output_folder+namef_rc_jet_pt_mc).c_str(),"RECREATE");
    gROOT->cd();
    ...
    ntuple->Project("hcs_diffsign","jet_pt",diffsign_cut_mc);
    ntuple->Project("hcs_samesign","jet_pt",samesign_cut_mc);
