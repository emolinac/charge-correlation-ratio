...
int main()
{
    ...
    TFile* fout = new TFile((output_folder+namef_rc_jet_pt_data_d).c_str(),"RECREATE");
    gROOT->cd();
    ...
    TH1F* hdecays_diffsign = new TH1F("hdecays_diffsign","",Nbin_jet_pt,jet_pt_limits);
    ...
    TH1F* hdecays_samesign = new TH1F("hdecays_samesign","",Nbin_jet_pt,jet_pt_limits);

    // Get the string breaking fraction
    ntuple_decays->Project("hall_diffsign"   ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==0");
    ntuple_decays->Project("hstrbrk_diffsign","jet_pt",jet_cuts+trackmc_cuts+"eq_charge==0&&lh_motherid<22&&lh_motherid>-10&&nlh_motherid<22&&nlh_motherid>-10");
    ntuple_decays->Project("hall_samesign"   ,"jet_pt",jet_cuts+trackmc_cuts+"eq_charge==1");
    ntuple_decays->Project("hstrbrk_samesign","jet_pt",jet_cuts+trackmc_cuts+"eq_charge==1&&lh_motherid<22&&lh_motherid>-10&&nlh_motherid<22&&nlh_motherid>-10");
    ...
    fout->cd();
    hdecays_diffsign->Write("strbrkfrac_diffsign");
    hdecays_samesign->Write("strbrkfrac_samesign");
    rc->Write("rc_jet_pt_decays");
    gROOT->cd();
